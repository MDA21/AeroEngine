...
namespace Aero {
	namespace RHI {
		...
		public:
			...
			float get_timestamp_period_ns() const {
				return _timestampPeriodNs;
			}
			...
			StagingRingBuffer& get_staging_ring_buffer() {
				return _stagingRingBuffer;
			}
			...
			AsyncUploadContext& get_async_upload_context() {
				return _asyncUploadContext;
			}
